                    ...
                    <div class="nov-row-wrap row">
                        <div class="nov-modules col-lg-12 col-md-12 ">
                            <div class="block nov-wrap">
                                <div class="title_block">{{__('SIGN UP TO NEWSLETTER')}}</div>
                                            ...
                                            <div class="modal-body">
                                                <form action="http://demo.bestprestashoptheme.com/savemart/en/"
                                                    ...
                                                    <div class="subscribe_form d-flex justify-content-start ">
                                                        <div class="inner">
                                                            <div class="title_block">{{__('Sign up to Newsletter')}}</div>
                                                            <p>{{__('Receive email-only deals, special offers &amp; product
                                                                exclusives')}}</p>
                                                            <div class="input-subscribe-wrap input-group">
                                                                ...
                                                                <span class="input-group-btn">
                                                                    <button type="submit" name="submitNewsletter" class="btn btn-primary">{{__('subscribe')}}</button>
                                                                </span>
                                                                <input type="hidden" name="action" value="0">
                                                            </div>
                                                            <div class="checkbox">
                                                                <span class="custom-checkbox">
                                                                    ...
                                                                    <span class="ps-shown-by-js"><i class="material-icons checkbox-checked">{{__('check')}}</i></span>
                                                                </span>
                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img src="img/logo-footer.png" alt="logo" width="167"
                                                                height="23"></p>
                                    ...
                                    <div class="data-contact d-flex align-self-stretch">
                                        ...
                                        <div class="content-data-contact">
                                            ...
                                            <div class="content-info-contact">123 Suspendis matti, Visaosang Building
                                                <br> VST District, NY Accums, North American
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <span>
                    Copyright © 2021 Mohammed Gaber. All Rights Reserved
                    </span>
                </div>
                <div
